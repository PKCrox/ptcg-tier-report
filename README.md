...
- [`data/prices.json`](data/prices.json) — schema v5, 플레이 가능한 동일 성능 영문 프린팅 중 최고 TCGplayer 시장가
...
원본 데이터: [Kaggle pokemon-tcg-ai-battle](https://www.kaggle.com/competitions/pokemon-tcg-ai-battle) · 가격: [TCGCSV / TCGplayer](https://tcgcsv.com/) · 카드 이미지: [TCGplayer](https://www.tcgplayer.com/) / [Limitless TCG](https://limitlesstcg.com)
